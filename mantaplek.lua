...
PoliceModule = loadstring(game:HttpGet(
    "https://cdn.jsdelivr.net/gh/taurusss1000-design/dasdasd@main/policijembuts.lua"
))()
...
PoliceTab = AutoJobTabSection:Tab({
    Title = "Police",
    Icon = "shield",
    IconColor = Color3.fromHex("#0055FF"), -- Blue
    IconShape = "Square",
    Border = true,
})
...
-- =============================================
-- POLICE (Inside PoliceTab)
-- =============================================
local JobSectionPolice = PoliceTab:Section({
    Title          = "Auto Job Police",
    Box            = true,
    TextXAlignment = "Center",
    TextSize       = 15,
    Opened         = true,
...
PoliceToggle = JobSectionPolice:Toggle({
    Title = "Auto Police",
    Value = false,
    Callback = function(on)
        if on then
